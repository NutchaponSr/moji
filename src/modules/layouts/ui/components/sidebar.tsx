...
export const Sidebar = ({ organizationId }: Props) => {
  ...
  return (
    <aside 
      ref={ref} 
      className={cn(
        "order-1 grow-0 shrink-0 relative z-111 bg-[#f8f8f7] w-60 transition group/sidebar",
    ...
    >
      ...
      <div className="w-1 absolute right-0 top-0 h-full group/line">
        <div 
          ...
          className="transition cursor-ew-resize h-full w-px group-hover/line:w-1 bg-[#eeeeec] absolute right-0 top-0" 
        />
      </div>
    </aside>
  );

...
export const Navigation = ({
  ...
  return (
    <div role="button" className="select-none transition cursor-pointer flex font-medium hover:bg-[#00000008]">
      <div className="flex items-center w-full text-sm min-h-7 h-7 px-2 py-1 gap-2">
        <div className="shrink-0 grow-0 size-5.5 flex items-center justify-center">
          <Icon icon={icon} width={20} height={20} className="text-[#73726e] stroke-3" />
        </div>
